...
* Virtualization techniques offer administrative tasks such as installing software planning new VMs, optimizing number of VMs and so forth at runtime.
...
* There are hundreds of system calls in a 64bit OS.
  * Eg. sys\_enter, sys\_exit
* The x86\_64 provides > 322 system calls and the x86 provides > 358 different system calls
...
* This type of hypervisor is named as **"Bare-metal Hypervisor"** E.g: Hyper-V, VMware, ESX/ESXi, XEN
...
*   Virtual memory is a memory management technique.
    ...
    *
    ...
    <img src="../.gitbook/assets/memory-impact.jpg" alt="" data-size="original">
*   In VMs, we have hypervisors !! if so, how mapping happens ?
    ...
    *
    ...
    <img src="../.gitbook/assets/memory-impact-v2.jpg" alt="" data-size="original">
